 ...
 * @param   {object}    objCheckBox Sélecteur de la checkbox sur laquelle appliquer le changement de titre
 * @param   {boolean}   isCheck     Booléen indiquant si la checkbox est cochée
 */
 ...
 * @author  Xavier VILLEMIN
 * @param   {object} objClick Checkbox déclenchant la fonction
 */
